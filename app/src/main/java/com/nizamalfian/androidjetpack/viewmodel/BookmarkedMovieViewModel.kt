 ...
 * on 8/13/2019
 */
class BookmarkedMovieViewModel(private val academyRepository: MovieRepository): ViewModel() {
    fun getBookmarks(): LiveData<Resource<PagedList<MovieEntity>>> = academyRepository.getBookmarkedMoviesAsPaged()
