...
class BookmarkedMovieTest {

    private lateinit var viewModel: BookmarkedMovieViewModel
    ...
    @Before
    fun setUp() {
        viewModel = BookmarkedMovieViewModel(academyRepository)
    }
    ...
    fun testGetCourses(){
        ...
        Mockito.`when`(academyRepository.getBookmarkedMoviesAsPaged()).thenReturn(bookmarkedMovies)
        ...
        Mockito.verify(academyRepository).getBookmarkedMoviesAsPaged()
    }
