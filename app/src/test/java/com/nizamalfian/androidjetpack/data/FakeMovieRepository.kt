...
import com.nizamalfian.androidjetpack.data.source.local.entity.*
...
import com.nizamalfian.androidjetpack.data.source.remote.response.*
...
class FakeMovieRepository(
    ...
    override fun getAllMovies(): LiveData<Resource<List<MovieEntity>>> {
        return object : NetworkBoundResource<List<MovieEntity>, List<MovieResponse>>(appExecutors) {
            override fun loadFromDB(): LiveData<List<MovieEntity>> = localRepository.getAllMovies()
