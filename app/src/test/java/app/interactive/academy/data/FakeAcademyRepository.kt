...
class FakeAcademyRepository(
    ...
    companion object {
        ...
        fun getInstance(localRepository: LocalRepository, remoteRepository: RemoteRepository,appExecutors: AppExecutors): FakeAcademyRepository {
            if (INSTANCE == null) {
                synchronized(FakeAcademyRepository::class.java) {
                    if (INSTANCE == null) {
                        INSTANCE =
                            FakeAcademyRepository(localRepository, remoteRepository,appExecutors)
                    }
                }
            }
